...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	 ...
	 */
	src: {
		// "auto"：自动收录 src/assets/images/DesktopWallpaper/ 目录下的全部图片
		// （png/jpg/jpeg/webp/avif，文件名随意），多张时每次刷新随机显示一张。
		// 想手动指定就换成单张字符串或数组，例如：
			...
			links: [
				{
					...
					url: "https://github.com/xieguu/www-set",
					showName: true,
				},
				{
					name: "Email",
					icon: "fa7-solid:envelope",
					url: "mailto:2971859518@qq.com",
				},
				{
					name: "Sponsor",
